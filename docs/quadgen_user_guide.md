...
If you are completely new to QTR or L* measurements, start with the workflow primer in `docs/quadgen_workflow.md` and the measurement pipeline notes in `docs/LAB_LINEARIZATION_WORKFLOW.md`.

## 2. quadGEN in the Studio Workflow
...
## 6. Workflow A — Build a Starter `.quad`
...
## 7. Workflow B — Linearize with LAB Measurements
...
## 8. Workflow C — Importing EDN or Photoshop Curves
...
## 10. Auto Endpoint Rolloff & Intents
...
- **Curve appears mirrored**: Confirm you are interpreting printer-space mapping. Refer to `docs/LAB_LINEARIZATION_WORKFLOW.md` for orientation tips.
